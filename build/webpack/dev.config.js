...
module.exports = {devserver: devServerOpts,
    ...
    entry: {main: ['webpack-dev-server/client?http://0.0.0.0:' + devServerOpts.port,
                'webpack/hot/only-dev-server',
                'Main'],
        vendor: ['react', 'backbone']

    },

    output: {path: path.join(__dirname, '../../dist/bundle/js'),
        publicPath: '/js',
